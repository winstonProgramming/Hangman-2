...
easy_button = ctk.CTkButton(settings_frame, text="Easy - 10 guesses", font=('Helvetica', 28), command=lambda: select_difficulty("Easy"))
easy_button.pack(pady=5)
medium_button = ctk.CTkButton(settings_frame, text="Medium - 9 guesses", font=('Helvetica', 28), command=lambda: select_difficulty("Medium"))
medium_button.pack(pady=5)
hard_button = ctk.CTkButton(settings_frame, text="Hard - 8 guesses", font=('Helvetica', 28), command=lambda: select_difficulty("Hard"))
hard_button.pack(pady=5)
hard_button = ctk.CTkButton(settings_frame, text="Impossible - 7 guesses", font=('Helvetica', 28), command=lambda: select_difficulty("Impossible"))
hard_button.pack(pady=5)
...
attempts_label = ctk.CTkLabel(game_frame, text="Guesses left: " + str(guesses_left), font=('Helvetica', 24, "bold"), text_color="black")
